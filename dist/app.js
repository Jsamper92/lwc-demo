...
function stylesheet$1(hostSelector, shadowSelector, nativeShadow) {
  return [".title", shadowSelector, " {display: flex;}\n"].join('');
}
  ...
  async loadLibrary() {
    {
      ...
      const {
        default: Lib
      } = await import('./iconSvgTemplates-af71b22a.js');
    ...
    if (this.isReady) {
      ...
      if (!this.src) {
        ...
        if (isValidName(name)) {
          ...
          const template = this.iconSvgTemplates[`${spriteName}_${iconName}`];
...
function tmpl$6($api, $cmp, $slotset, $ctx) {
  ...
  return [api_custom_element("lightning-card", _lightningCard, {
    ...
    key: 4
  }, [api_text("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.")])]), api_element("div", {
    classMap: {
      "slds-m-around_medium": true
    },
    key: 7
    ...
    attrs: {
      "src": "/public/images/astro-sun.png"
    },
    key: 6
  }, [])])], $slotset), api_custom_element("lightning-button", _lightningButton, {
    attrs: {
      "slot": "footer"
    },
    props: {
...
tmpl$6.stylesheetTokens = {
  hostAttribute: "demo-card_card-host",
  shadowAttribute: "demo-card_card"
};

class Card extends BaseLightningElement {}

var _demoCard = registerComponent(Card, {
  tmpl: _tmpl$7
});

function stylesheet$3(hostSelector, shadowSelector, nativeShadow) {
  return ["\n", (nativeShadow ? ":host {--sds-c-card-color-background: #080707;--sds-c-card-text-color: #fff;--sds-c-card-radius-border: 16px;--sds-c-card-heading-font-weight: 400;--sds-c-card-footer-color-border: transparent;--sds-c-card-footer-spacing-block-start: 12px;--sds-c-card-footer-spacing-block-end: 24px;--sds-c-button-text-font-weight: 700;--sds-c-button-text-color: #fff;--sds-c-button-radius-border: 24px;--sds-c-button-color-border: #fff;--sds-c-button-sizing-border: 2px;--sds-c-button-spacing-block-start: 8px;--sds-c-button-spacing-block-end: 8px;--sds-c-button-spacing-inline-start: 24px;--sds-c-button-spacing-inline-end: 24px;--sds-c-badge-color-background: #0176D3;--sds-c-badge-radius-border: 4px;--sds-c-badge-text-color: #fffff;}" : [hostSelector, " {--sds-c-card-color-background: #080707;--sds-c-card-text-color: #fff;--sds-c-card-radius-border: 16px;--sds-c-card-heading-font-weight: 400;--sds-c-card-footer-color-border: transparent;--sds-c-card-footer-spacing-block-start: 12px;--sds-c-card-footer-spacing-block-end: 24px;--sds-c-button-text-font-weight: 700;--sds-c-button-text-color: #fff;--sds-c-button-radius-border: 24px;--sds-c-button-color-border: #fff;--sds-c-button-sizing-border: 2px;--sds-c-button-spacing-block-start: 8px;--sds-c-button-spacing-block-end: 8px;--sds-c-button-spacing-inline-start: 24px;--sds-c-button-spacing-inline-end: 24px;--sds-c-badge-color-background: #0176D3;--sds-c-badge-radius-border: 4px;--sds-c-badge-text-color: #fffff;}"].join('')), "\n"].join('');
}
...
function tmpl$7($api, $cmp, $slotset, $ctx) {
  ...
  return [api_custom_element("lightning-card", _lightningCard, {
    ...
    key: 4
  }, [api_text("When Codey gets a barrage of notifications from all of his social media, he realizes he has been hacked! Codey must rise up to the challenge of figuring out who attacked him and learn to fight back in order to gain control of his online presence once again.")])]), api_element("div", {
    classMap: {
      "slds-m-around_medium": true
    },
    key: 7
    ...
    attrs: {
      "src": "/public/images/codey-sitting-desk.png"
    },
    key: 6
  }, [])])], $slotset), api_custom_element("lightning-button", _lightningButton, {
    attrs: {
...
tmpl$7.stylesheetTokens = {
  hostAttribute: "demo-customizedComponent_customizedComponent-host",
  shadowAttribute: "demo-customizedComponent_customizedComponent"
};

class CustomizedComponent extends BaseLightningElement {}

var _demoCustomizedComponent = registerComponent(CustomizedComponent, {
  tmpl: _tmpl$8
});
...
function tmpl$8($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("header", {
    ...
    key: 6
  }, [api_text("1 \u2013 Default Component")]), api_custom_element("demo-card", _demoCard, {
    key: 7
  }, [])]), api_element("div", {
    classMap: {
      "pointer": true,
    ...
    key: 11
  }, [api_text("2 \u2013 Customized Component")]), api_custom_element("demo-customized-component", _demoCustomizedComponent, {
    key: 12
  }, [])])]), api_element("footer", {
    classMap: {
      "fork": true
    ...
    key: 15
  }, [api_text("Want to see the code?")]), api_element("a", {
    classMap: {
      "fork__link": true
    },
    attrs: {
      "href": "https://codesandbox.io/s/charming-danilo-y8bby"
    },
    key: 16
  }, [api_text("\u2728 Fork the Demo \u2728")])])];
}
...
export { _tmpl$1 as _, registerComponent as a, registerTemplate as r };
